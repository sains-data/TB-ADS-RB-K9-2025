---
title: "Penerapan Analisis Data Eksplorasi (EDA) pada Data Antropometri Mahasiswa ITERA Menggunakan RStudio"
author: "Kelompok 9"
date: "2025-11-28"
...
# ================================================================
df_data <- read_csv("data_bersihfix - Sheet1.csv")
...
if (is.na(kolom_tinggi) | is.na(kolom_berat)) {
  stop("❌ Kolom tinggi badan atau berat badan tidak ditemukan dalam dataset.")
}
